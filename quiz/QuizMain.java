...
public class QuizMain {
    public static void main(String[] args) {
        ...
        System.out.println("=== removeFromBox() 사용 후 문제 목록 ===");
        quizBox.printAll();
        ...
        if (removed) {
            System.out.println("바나나 문제가 정상적으로 삭제되었습니다.");
        } else {
            System.out.println("바나나 문제 삭제에 실패했습니다.");
        }

        System.out.println("=== remove() 사용 후 최종 문제 목록 ===");
        quizBox.printAll();
    }
}
